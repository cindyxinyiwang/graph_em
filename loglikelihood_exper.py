...
if __name__ == "__main__":
	...
	test_graph_name = sys.argv[2]
	result_dir = "results_new/"+sys.argv[3] + "/"
	split = int(sys.argv[4])
	ensure_dir(result_dir)
	num_test_sample = 100
	test_nums = [4, 6, 15, 16, 21, 23, 35, 44, 58, 72, 75, 78, 120, 127, 132, 138, 143, 148, 152, 156, 162, 167, 185, 190]
	#test_nums = [127]

...
def new_visit(datree, graph, prod_rules, left_deriv_prod_rules, indent=0, parent=None, TD=False):
    G=graph
...
def add_to_prod_rules(production_rules, left_deriv_prod_rules, lhs, rhs, s):
    ...
    left_deriv_prod_rules.append( " ".join([lhs_str, "->", rhs_str]))
